<x-app-layout>
    ...
    <div class="mx-auto max-w-5xl space-y-5 px-4 sm:px-6 lg:px-8">
        <div class="flex flex-wrap gap-2">
            <a href="{{ route('admin.students.reset_import') }}" class="rounded bg-rose-700 px-4 py-2 text-sm font-semibold text-white">Reset & nhập dữ liệu mới</a>
            <a href="{{ route('admin.students.index') }}" class="rounded border border-slate-300 px-4 py-2 text-sm font-semibold text-slate-700">Về danh sách học sinh</a>
        </div>
